...
SECRET_KEY = 'django-insecure-e56wzg(@mc8kdhu(--&9^3dcx0f(gn#27xgd%@kgpt$c36w#$o'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.categories.menu_links',
                'carts.adventure_in_cart_count.counter',
            ],
        },
    },
]
...
STATICFILES_DIRS = ['travelapp/static']
